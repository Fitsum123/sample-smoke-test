...
public class ACPOCreateNewFacilityDCR : PageObject
{
    ...
    public string testCreateFacilityDCR()
    {
        //var driver = wd;
        //our class exposes a safer findelement so remap to that
        const string facilityName = "Test123";
        const string owningEntityName = "TestING-Wnning";
        const string typeOfBusiness = "Local Government";
        const string facilityAddressLine1 = "401 jacklin road";
        const string facilityCity = "Milpitas";
        const string facilityZipCode = "95035";
        const string contactFirstName = "First";
        const string contactLastName = "Last";
        const string contactEmail = "testEmail@nospam.nope";
        const string contactPhone = "(415)555-1212";

        return testCreateFacilityDCR(facilityName, owningEntityName, typeOfBusiness, facilityAddressLine1, facilityCity, facilityZipCode, contactFirstName, contactLastName, contactEmail, contactPhone);

    }

    public string testCreateFacilityDCR(string facilityName, string owningEntityName, string typeOfBusiness, string facilityAddressLine1, string facilityCity, string facilityZipCode, string contactFirstName, string contactLastName, string contactEmail, string contactPhone)
    {
        //var driver = wd;
        //our class exposes a safer findelement so remap to that
        var driver = this;
        ...
        driver.FindElement(By.Id("PrimaryOperationCategory1")).Click();
