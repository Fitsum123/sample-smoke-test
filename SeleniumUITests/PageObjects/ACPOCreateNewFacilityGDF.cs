...
public class ACPOCreateNewFacilityGDF : PageObject
{
    ...
    public string testCreateFacilityGDF()
    {
        //var driver = wd;
        //our class exposes a safer findelement so remap to that
        const string facilityName = "Test";
        const string owningEntityName = "OWNING NAME";
        const string typeOfBusiness = "Local Government";
        const string facilityAddressLine1 = "424 32nd Ave";
        const string facilityCity = "San Francisco";
        const string facilityZipCode = "94121";
        ...
        return testCreateFacilityGDF(facilityName, owningEntityName, typeOfBusiness, facilityAddressLine1, facilityCity, facilityZipCode, contactFirstName, contactLastName, contactEmail, contactPhone);

    }

    public string testCreateFacilityGDF(string facilityName, string owningEntityName, string typeOfBusiness, string facilityAddressLine1, string facilityCity, string facilityZipCode, string contactFirstName, string contactLastName, string contactEmail, string contactPhone)
    {
        //var driver = wd;
        //our class exposes a safer findelement so remap to that
        var driver = this;
